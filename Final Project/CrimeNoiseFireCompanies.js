...
let state = {
   ...
   Promise.all([
    d3.json("../data/ProjectDataFinal/NoiseFireCompanies.geojson"),
    d3.csv("../data/ProjectDataFinal/csv/NoiseFireCompanies.csv"),
...
function draw() {
  ...
  .style("left", 20 + "px")
    .html(
      `<div>Average Number of Noise Complaints Per Fire Company District: 4030</div>
