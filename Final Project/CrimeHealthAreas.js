...
let state = {
   ...
   Promise.all([
    d3.json("../data/ProjectDataFinal/CrimeHealthAreas.geojson"),
    d3.csv("../data/ProjectDataFinal/csv/HateCrimeHealthAreas.csv")
...
function draw() {
  ...
  .style("left", 20 + "px")
    .html(
      `<div>Average Number of Hate Crimes Per Health Area: 34</div>
