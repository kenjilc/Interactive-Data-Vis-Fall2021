...
let state = {
   ...
   Promise.all([
    d3.json("../data/ProjectDataFinal/NoiseMunicpalCourt.geojson"),
    d3.csv("../data/ProjectDataFinal/csv/NoiseMunicpalCourt.csv")
...
function draw() {
  ...
  .style("left", 20 + "px")
    .html(
      `<div>Average Number of Noise Complaints Per Municpal Court: 60450</div>
