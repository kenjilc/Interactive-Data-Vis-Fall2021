...
let state = {
   ...
   Promise.all([
    d3.json("../data/ProjectDataFinal/NoiseMiddleSchool.geojson"),
    d3.csv("../data/ProjectDataFinal/csv/NoiseMiddleSchool.csv")
...
function draw() {
  ...
  .style("left", 20 + "px")
    .html(
      `<div>Average Number of Noise Complaints Per Middle School District: 10075</div>
