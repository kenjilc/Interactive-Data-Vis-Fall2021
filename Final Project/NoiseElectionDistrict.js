...
let state = {
   ...
   Promise.all([
    d3.json("../data/ProjectDataFinal/NoiseElectionDistrict.geojson"),
    d3.csv("../data/ProjectDataFinal/csv/NoiseElectionDistrict.csv")
...
function draw() {
  ...
  .style("left", 15 + "px")
    .html(
      `<div>Average Number of Noise Complaints Per Election District: 376</div>
      <div>Election Districts: ${state.hover_state}</div>
