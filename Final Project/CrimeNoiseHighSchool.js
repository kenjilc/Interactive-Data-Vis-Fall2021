...
let state = {
   ...
   Promise.all([
    d3.json("../data/ProjectDataFinal/NoiseHighSchool.geojson"),
    d3.csv("../data/ProjectDataFinal/csv/NoiseHighSchool.csv"),
...
function draw() {
  ...
  .style("left", 15 + "px")
    .html(
      `<div>Average Number of Noise Complaints Per High School District: 24183</div
